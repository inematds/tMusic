...
export const MUSICAS: MusicItem[] = [
  ...
  { position: 5, id: 'trk_5', title: 'Forró Cyborg', artists: ['DJ Sertão'], isAiGenerated: false, trend24h: 0.04, trend7d: 0.16, likes: 1900, dislikes: 70, views: 72000, links: { spotify: 'https://open.spotify.com/track/mock5' } },
  ...
  { position: 7, id: 'trk_7', title: 'BregaWave', artists: ['MC Pará'], isAiGenerated: false, trend24h: 0.03, trend7d: 0.12, likes: 1500, dislikes: 55, views: 60000, links: { spotify: 'https://open.spotify.com/track/mock7' } },
  { position: 8, id: 'trk_8', title: 'Axé Quantum (AI Edit)', artists: ['Bahia Beat'], isAiGenerated: true, origin: 'Custom', trend24h: 0.02, trend7d: 0.10, likes: 1300, dislikes: 50, views: 54000, links: { youtube: 'https://youtube.com/watch?v=mock8' } },
  { position: 9, id: 'trk_9', title: 'Drill Amazônia', artists: ['MC Norte'], isAiGenerated: false, trend24h: 0.02, trend7d: 0.09, likes: 1200, dislikes: 48, views: 52000, links: { spotify: 'https://open.spotify.com/track/mock9' } },
  { position: 10, id: 'trk_10', title: 'Sertanejo Holográfico (AI Cover)', artists: ['Dupla 5G'], isAiGenerated: true, origin: 'Canto', trend24h: 0.01, trend7d: 0.08, likes: 1100, dislikes: 42, views: 50000, links: { youtube: 'https://youtube.com/watch?v=mock10' } },
];
...
export const BANDAS: BandItem[] = [
  ...
  { position: 6, id: 'bnd_6', name: 'Forró Cyborg', members: ['DJ Sertão', 'MC Cabra'], trend24h: 0.03, trend7d: 0.13, likes: 1400, dislikes: 45, views: 44000, links: { profile: 'https://example.com/band/bnd_6' } },
  { position: 7, id: 'bnd_7', name: 'Axé Quantum', members: ['Beto', 'Lia'], trend24h: 0.03, trend7d: 0.12, likes: 1300, dislikes: 42, views: 42000, links: { profile: 'https://example.com/band/bnd_7' } },
  { position: 8, id: 'bnd_8', name: 'BregaWave', members: ['MC Pará', 'DJ Belém'], trend24h: 0.02, trend7d: 0.11, likes: 1200, dislikes: 40, views: 40000, links: { profile: 'https://example.com/band/bnd_8' } },
...
export const DJS: DjItem[] = [
  ...
  { position: 4, id: 'dj_4', name: 'DJ Belém', aliases: ['Bel3m'], trend24h: 0.05, trend7d: 0.18, likes: 1900, dislikes: 65, views: 73000, links: { profile: 'https://example.com/dj/dj_4' } },
  { position: 5, id: 'dj_5', name: 'DJ Sertão', aliases: ['SertaoX'], trend24h: 0.04, trend7d: 0.15, likes: 1700, dislikes: 60, views: 69000, links: { profile: 'https://example.com/dj/dj_5' } },
  ...
  { position: 8, id: 'dj_8', name: 'DJ Pará', aliases: [], trend24h: 0.02, trend7d: 0.11, likes: 1400, dislikes: 52, views: 59000, links: { profile: 'https://example.com/dj/dj_8' } },
